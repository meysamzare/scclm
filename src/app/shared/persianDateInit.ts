import { DateAdapter, MatDatepickerIntl } from "@angular/material";
...
export const PERSIAN_DATE_FORMATS = {
    ...
    display: {
        dateInput: "jYYYY/jMM/jDD",
        monthYearLabel: "انتخاب سال / jYYYY jMMMM",
...
@Injectable()
export class MatDatePickerInit extends MatDatepickerIntl {
    nextMonthLabel = "ماه بعد";
    calendarLabel: string = "تقویم";
    /** A label for the button used to open the calendar popup (used by screen readers). */
    openCalendarLabel: string = "بازکردن تقویم";
    /** A label for the previous month button (used by screen readers). */
    prevMonthLabel: string = "ماه قبل";
    /** A label for the previous year button (used by screen readers). */
    prevYearLabel: string = "سال قبل";
    /** A label for the next year button (used by screen readers). */
    nextYearLabel: string = "سال بعد";
    /** A label for the previous multi-year button (used by screen readers). */
    prevMultiYearLabel: string = "صفحه قبل";
    /** A label for the next multi-year button (used by screen readers). */
    nextMultiYearLabel: string = "صفحه بعد";
    /** A label for the 'switch to month view' button (used by screen readers). */
    switchToMonthViewLabel: string = "نمای ماه";
    /** A label for the 'switch to year view' button (used by screen readers). */
    switchToMultiYearViewLabel: string = "نمای سال";
}
