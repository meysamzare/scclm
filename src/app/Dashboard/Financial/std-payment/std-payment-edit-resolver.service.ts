...
export class StdPaymentEditResolverService implements Resolve<any>{
    constructor(
    ...
    async resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot) {
        ...
        if (id) {
            if (id == 0) {
                ...
                return of(new IStdPayment()).toPromise();
            }

            return this.auth.post("/api/StdPayment/getStdPayment", id).pipe(
                take(1),
