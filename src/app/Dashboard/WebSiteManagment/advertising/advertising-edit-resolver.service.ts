...
export class AdvertisingEditResolverService implements Resolve<any>{
    ...
    async resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot) {
        ...
        if (id) {
            if (id == 0) {
                ...
                return of(new IAdvertising()).toPromise();
            }

            return this.auth.post("/api/Advertising/getAd", id).pipe(
                take(1),
