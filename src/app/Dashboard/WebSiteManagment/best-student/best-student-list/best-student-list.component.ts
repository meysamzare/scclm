...
@Component({
    selector: 'app-best-student-list',
    templateUrl: './best-student-list.component.html',
    styleUrls: ['./best-student-list.component.scss']
})
export class BestStudentListComponent implements OnInit {
    ...
    dataSource: MatTableDataSource<IBestStudent>;
    selection = new SelectionModel<IBestStudent>(true, []);

    PAGE_Datas: IBestStudent[] = [];
    ...
    getCurrentDataOfPage(): IBestStudent[] {
        let List: IBestStudent[];
