...
export class PictureGalleryListComponent implements OnInit {
    ...
    dataSource: MatTableDataSource<IPictureGallery>;
    selection = new SelectionModel<IPictureGallery>(true, []);

    PAGE_Datas: IPictureGallery[] = [];
    ...
    getCurrentDataOfPage(): IPictureGallery[] {
        let List: IPictureGallery[];
