...
@Injectable()
export class TimeScheduleEditResolverService implements Resolve<any>{
    constructor(
    ...
    async resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot) {
        ...
        if (id) {
            if (id == 0) {
                ...
                return of(new ITimeSchedule()).toPromise();
            }

            return this.auth.post("/api/TimeSchedule/getTimeSchedule", id).pipe(
                take(1),
