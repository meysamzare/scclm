...
import { ExamAnalizeData } from '../exam-analize/exam-analize.component';
import { trigger, transition, style, animate } from '@angular/animations';
import { MatDialog } from '@angular/material';
import { ExamDetailsComponent } from '../../home/exam-details/exam-details.component';

@Component({
    selector: 'app-exam-analize-stdtype',
    templateUrl: './exam-analize-stdtype.component.html',
    styleUrls: ['./exam-analize-stdtype.component.scss'],
    animations: [
        trigger(
            "enterAnim", [
            transition(":enter", [
        ...
        if (this.examAnalizeDatas.find(c => c.ID == this.selectedExam)) {
            ...
            this.auth.post("/api/Exam/getExamAnalizeData", this.selectedExam, {
                ...
                if (data.success) {
                    ...
                    if (arrayOfTypeChartData.length == 0) {
                        return this.message.showWarningAlert("گروهی برای این آزمون تعریف نشده است");
                    }
